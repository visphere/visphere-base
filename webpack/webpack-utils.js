 ...
 *
 *    File name: webpack-utils.js
 *    Last modified: 7/29/23, 9:00 PM
...
module.exports = {
    tailwindGlobalSassLoader: ({ stylesPath, postCssConfig, miniCssLoader, cdnBaseUrl }) => ({
        test: /\.(sa|sc|c)ss$/,
        include: [
    ...
    angularCommonWebpackScssLoader: ({ includePath, excludePath, postCssConfig }) => ({
        test: /\.(sa|sc|c)ss$/,
        type: "asset/source",
        include: includePath,
        exclude: [
